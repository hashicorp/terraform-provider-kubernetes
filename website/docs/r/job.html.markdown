...
* `spec` - (Required) Specification of the desired behavior of a job. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
