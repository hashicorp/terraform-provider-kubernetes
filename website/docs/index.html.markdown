...
* `config_content` - (Optional) The kube config as a string. This can be useful when sourcing from outputs or data resources. It is mutually exclusive with `config_path`. 
