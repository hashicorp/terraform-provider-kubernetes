		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					v6resource.TestCheckResourceAttr(resourceName, "type", "Opaque"),
					v6resource.TestCheckResourceAttr(resourceName, "immutable", "false"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					v6resource.TestCheckResourceAttrSet(resourceName, "metadata.0.uid"),
					v6resource.TestCheckResourceAttr(resourceName, "data.%", "2"),
					v6resource.TestCheckResourceAttr(resourceName, "data.username", "admin"),
					v6resource.TestCheckResourceAttr(resourceName, "data.password", "password"),
					v6resource.TestCheckResourceAttr(resourceName, "type", "kubernetes.io/basic-auth"),
