		...
		"lifecycle": {
			...
			Elem: &schema.Resource{
				Schema: map[string]*schema.Schema{
					...
					"stop_signal": {
						Type:        schema.TypeString,
						Description: `stop_signal defines which signal will be sent to a container when it is being stopped. Must be a valid signal for the container's OS. In Linux, once the container's init process is PID 1, the signal will be sent to the container's PID 1 process instead. StopSignal can only be set for Pods with a non-empty .spec.os.name.`,
						Optional:    true,
						ForceNew:    !isUpdatable,
						ValidateFunc: validation.StringInSlice([]string{
							...
							"SIGRTMIN+10", "SIGRTMIN+11", "SIGRTMIN+12", "SIGRTMIN+13", "SIGRTMIN+14", "SIGRTMIN+15",
							"SIGRTMAX", "SIGRTMAX-1", "SIGRTMAX-2", "SIGRTMAX-3", "SIGRTMAX-4",
							"SIGRTMAX-5", "SIGRTMAX-6", "SIGRTMAX-7", "SIGRTMAX-8", "SIGRTMAX-9",
							"SIGRTMAX-10", "SIGRTMAX-11", "SIGRTMAX-12", "SIGRTMAX-13", "SIGRTMAX-14",
						}, false),
					},
				},
			},
