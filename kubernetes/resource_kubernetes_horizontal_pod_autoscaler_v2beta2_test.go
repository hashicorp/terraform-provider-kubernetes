		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.0.external.0.metric.0.name", "queue_size"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.0.external.0.metric.0.selector.0.match_labels.queue_name", "test"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.0.external.0.target.0.type", "Value"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.0.external.0.target.0.value", "10"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.1.type", "Object"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.1.object.0.metric.0.name", "requests-per-second"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.1.object.0.target.0.type", "AverageValue"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.1.object.0.target.0.average_value", "2k"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.1.object.0.described_object.0.kind", "Ingress"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.1.object.0.described_object.0.name", "main-route"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.1.object.0.described_object.0.api_version", "networking.k8s.io/v1beta1"),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.3.type", "Resource"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.3.resource.0.name", "test"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.3.resource.0.target.0.type", "Utilization"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.metric.3.resource.0.target.0.average_utilization", "1"),
				),
			},
			{
