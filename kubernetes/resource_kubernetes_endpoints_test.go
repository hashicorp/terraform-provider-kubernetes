		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.0.address.4043229419.ip", "10.0.0.4"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.0.address.#", "1"),
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.0.address.761794926.ip", "10.0.0.5"),
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.0.port.#", "1"),
					...
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.1.address.3580306450.ip", "10.0.0.6"),
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.1.address.3580306450.hostname", "test-hostname"),
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.1.address.3580306450.node_name", "test-nodename"),
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.1.address.1295295525.ip", "10.0.0.7"),
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.1.not_ready_address.678871443.ip", "10.0.0.10"),
					resource.TestCheckResourceAttr("kubernetes_endpoints.test", "subset.1.not_ready_address.4125104150.ip", "10.0.0.11"),
