resource "kubernetes_daemon_set_v1_gen" {
  package = "appsv1"

  api_version = "apps/v1"
  kind        = "DaemonSet"

  description = "damonset"

  output_filename_prefix = "daemon_set"

  openapi {
    filename    = "./codegen/data/kubernetes-v1.28.3/api/openapi-spec/v3/apis__apps__v1_openapi.json"
    create_path = "/apis/apps/v1/namespaces/{namespace}/daemonsets"
    read_path   = "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}"
  }
