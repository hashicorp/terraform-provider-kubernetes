...
* `size_limit` - Total amount of local storage required for this EmptyDir volume. [More details here.](https://pkg.go.dev/k8s.io/apimachinery/pkg/api/resource?tab=doc#Quantity)
