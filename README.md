...
To contribute, please read the [contribution guidelines](https://github.com/terraform-providers/terraform-provider-kubernetes/blob/master/docs/CONTRIBUTING.md).