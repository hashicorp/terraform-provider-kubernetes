...
func (r *Job) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *Job) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var dataModel JobModel
...
func (r *Job) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var dataModel JobModel
...
func (r *Job) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r *Job) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	var dataModel JobModel
