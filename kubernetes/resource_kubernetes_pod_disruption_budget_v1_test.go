		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("kubernetes_pod_disruption_budget_v1.test", "metadata.0.uid"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.#", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.max_unavailable", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.min_available", ""),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.#", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_labels.%", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_labels.foo", "bar"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_expressions.#", "0"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.#", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.#", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.max_unavailable", ""),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.min_available", "75%"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.#", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_labels.%", "0"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_expressions.#", "1"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_expressions.0.key", "name"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_expressions.0.operator", "In"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_expressions.0.values.#", "2"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_expressions.0.values.1", "foo"),
					resource.TestCheckResourceAttr("kubernetes_pod_disruption_budget_v1.test", "spec.0.selector.0.match_expressions.0.values.0", "apps")),
			},
		},
	})
}
