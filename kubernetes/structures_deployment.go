...
func flattenDeploymentSpec(in appsv1.DeploymentSpec, d *schema.ResourceData, ignoredKeys []string) ([]interface{}, error) {
	...
	template["metadata"] = flattenMetadata(in.Template.ObjectMeta, d, ignoredKeys, "spec.0.template.0.")
