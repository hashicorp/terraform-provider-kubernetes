...
~> Read more about security properties and risks involved with using Kubernetes secrets in [Kubernetes Documentation](https://kubernetes.io/docs/concepts/configuration/secret/).
