...
func flattenDeploymentSpec(in appsv1.DeploymentSpec, d *schema.ResourceData, providerMetadata interface{}) ([]interface{}, error) {
	...
	template["metadata"] = flattenMetadata(in.Template.ObjectMeta, d, providerMetadata, "spec.0.template.0.")
