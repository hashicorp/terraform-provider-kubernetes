...
func (r *CronJob) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var dataModel CronJobModel
...
func (r *CronJob) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var dataModel CronJobModel
...
func (r *CronJob) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var dataModel CronJobModel
...
func (r *CronJob) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r *CronJob) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	var dataModel CronJobModel
