...
var _ resource.Resource = &CronJob{}
var _ resource.ResourceWithImportState = &CronJob{}
...
func (r *CronJob) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "kubernetes_cron_job_v1_gen"
}

func (r *CronJob) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
