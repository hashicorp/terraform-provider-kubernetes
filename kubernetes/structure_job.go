...
func flattenJobSpec(in batchv1.JobSpec, d *schema.ResourceData, ignoredKeys []string, prefix ...string) ([]interface{}, error) {
	...
	podSpec, err := flattenPodTemplateSpec(in.Template, d, ignoredKeys, prefix...)
	if err != nil {
		return nil, err
	}
