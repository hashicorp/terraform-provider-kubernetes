...
sidebar_current: "docs-kubernetes-resource-stateful-set-x"
description: |-
...
* `metadata` - (Required) Standard object's metadata. More info: [Kubernetes reference](https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata)

* `spec` - (Optional) Specification of the desired behavior of the pod. More info: [Kubernetes reference](https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status)
