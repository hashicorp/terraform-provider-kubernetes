...
* `automount_service_account_token` - (Optional) Indicates whether a service account token should be automatically mounted. For more info see [Kubernetes reference](https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/)
