...
sidebar_current: "docs-kubernetes-resource-api-service"
description: |-
...
* `metadata` - (Required) Standard API service's metadata. For more info see [Kubernetes reference](https://github.com/kubernetes/community/blob/e59e666e3464c7d4851136baa8835a311efdfb8e/contributors/devel/api-conventions.md#metadata)
...
* `self_link` - A URL representing this API service.
