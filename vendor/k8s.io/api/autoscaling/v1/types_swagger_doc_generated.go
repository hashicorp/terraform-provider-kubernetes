...
var map_HorizontalPodAutoscaler = map[string]string{
	...
	"spec":     "behaviour of autoscaler. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.",
