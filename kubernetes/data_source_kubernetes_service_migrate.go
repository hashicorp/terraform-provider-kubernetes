...
// dataSourceKubernetesServiceV0 is a copy of the Kubernetes Service schema (before migration).
func dataSourceKubernetesServiceV0() *schema.Resource {
...
func dataSourceKubernetesServiceStateUpgradeV0(ctx context.Context, rawState map[string]interface{}, meta interface{}) (map[string]interface{}, error) {
