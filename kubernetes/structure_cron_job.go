...
func flattenCronJobSpec(in v1beta1.CronJobSpec, d *schema.ResourceData, providerMetadata interface{}) ([]interface{}, error) {
	...
	jobTemplate, err := flattenJobTemplate(in.JobTemplate, d, providerMetadata)
	if err != nil {
		return nil, err
	}
...
func flattenJobTemplate(in v1beta1.JobTemplateSpec, d *schema.ResourceData, providerMetadata interface{}) ([]interface{}, error) {
	att := make(map[string]interface{})
