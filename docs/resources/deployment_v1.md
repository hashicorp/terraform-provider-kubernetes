...
- `restart_policy` (String) Restart policy for all containers within the pod. Only "Always" is a valid value. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#restart-policy.
